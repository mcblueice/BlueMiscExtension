...
public class StepAssistEffect implements ArmorEffect {
    private static final String EffectKey = "step_assist";
    private static final Attribute attribute = Attribute.STEP_HEIGHT;
    ...
    private static final float baseCost = 5;
    ...
    public int calculateCost(Player player, float value) {
        int cost = Math.round(baseCost * value / 1.0f);
        return cost;
    }
