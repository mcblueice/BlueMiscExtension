...
public class SpeedEffect implements ArmorEffect {
    private static final String EffectKey = "speed";
    private static final Attribute attribute = Attribute.MOVEMENT_SPEED;
    ...
    private static final float baseCost = 10;
    ...
    public int calculateCost(Player player, float value) {
        int cost = Math.round(baseCost * value / 0.05f);
        return cost;
    }
