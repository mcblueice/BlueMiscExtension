...
public class JumpEffect implements ArmorEffect {
    private static final String EffectKey = "jump";
    private static final Attribute attribute = Attribute.JUMP_STRENGTH;
