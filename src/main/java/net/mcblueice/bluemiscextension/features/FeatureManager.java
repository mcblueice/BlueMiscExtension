...
import net.mcblueice.bluemiscextension.features.PhantomSpawnLimiter.PhantomSpawnLimiter;
...
import net.mcblueice.bluemiscextension.features.ClickThrough.ClickThrough;
...
public class FeatureManager {
    ...
    public void reload() {
        ...
        loadFeature("PhantomSpawnLimiter", PhantomSpawnLimiter::new);
    ...
    private <T extends Feature> T loadFeature(String name, String[] dependencies, Function<BlueMiscExtension, T> factory) {
        ...
        if (enabled) {
            ...
            if (missingDeps.isEmpty()) {
                ...
                Bukkit.getConsoleSender().sendMessage("[" + plugin.getName() + "]" + lang.get("FeatureManager.Enabled", depMsg, displayName));
                ...
                Bukkit.getConsoleSender().sendMessage("[" + plugin.getName() + "]" + lang.get("FeatureManager.Disabled", depMsg, displayName));
            }
        } else {
            Bukkit.getConsoleSender().sendMessage("[" + plugin.getName() + "]" + lang.get("FeatureManager.Closed", displayName));
        }
        return null;
    }
